...
public class MultiEventsTest
{
    ...
    public async Task Event1ThenEvent2_Success()
    {
        ...
        handler1Mock.Verify(d => d(e1, null, It.IsAny<CancellationToken>()), Times.Once);
        handler2Mock.Verify(d => d(It.IsAny<Event2>(), null, It.IsAny<CancellationToken>()), Times.Never);

        var e2 = new Event2();
        await service.PublishAsync(e2);
        handler1Mock.Verify(d => d(e1, null, It.IsAny<CancellationToken>()), Times.Once);
        handler2Mock.Verify(d => d(e2, null, It.IsAny<CancellationToken>()), Times.Once);
        ...
        handler1Mock.Verify(d => d(It.IsAny<Event1>(), null, It.IsAny<CancellationToken>()), Times.Never);
        handler2Mock.Verify(d => d(e2, null, It.IsAny<CancellationToken>()), Times.Never);
        handler2Mock.Verify(d => d(e2b, null, It.IsAny<CancellationToken>()), Times.Once);

        var e1b = new Event1();
        await service.PublishAsync(e1b);
        handler1Mock.Verify(d => d(e1, null, It.IsAny<CancellationToken>()), Times.Never);
        handler2Mock.Verify(d => d(e2, null, It.IsAny<CancellationToken>()), Times.Never);
        handler1Mock.Verify(d => d(e1b, null, It.IsAny<CancellationToken>()), Times.Once);
        handler2Mock.Verify(d => d(e2b, null, It.IsAny<CancellationToken>()), Times.Once);
